...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    ...
    */
    return handlerInput.responseBuilder
      .speak('Welcome to Paint Cast by Behr. I can help you with your coatings project. ' +
        'What city do you live in?')
      .reprompt('What city do you live in?')
      .getResponse();
  },
};
...
const CityIntetHandler = {
  canHandle(handlerInput) {
    ...
    console.log("request.intent.name: " + request.intent.name.value);
    console.log("request.dialogState: " + request.dialogState.value);
  ...
  handle(handlerInput) {
    ...
    console.log("CityIntentHandler currentIntent: " + currentIntent.value);
